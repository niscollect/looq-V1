...
//   "djxvscnkn", // ! process.env.CLOUDINARY_CLOUD_NAME
  api_key: process.env.CLOUDINARY_API_KEY,
//   "128617887955785", // ! process.env.CLOUDINARY_API_KEY
  api_secret: process.env.CLOUDINARY_API_SECRET,
//   "JP6mfaOMk_fUK5SiGpBTP3KMXB4", // ! process.env.CLOUDINARY_API_SECRET
});
